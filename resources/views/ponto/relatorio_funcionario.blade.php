...
@section('title', 'Relatório de Ponto - ' . $user->name)

@section('content')
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-file-alt me-2"></i>Relatório de Ponto: {{ $user->name }}</h1>
        <div>
            <a href="{{ route('users.show', $user) }}" class="btn btn-secondary me-2">
                <i class="fas fa-arrow-left me-1"></i>Voltar para Perfil
            </a>
            <a href="{{ route('users.index') }}" class="btn btn-outline-secondary">
                <i class="fas fa-list me-1"></i>Lista de Funcionários
            </a>
        </div>
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('ponto.relatorio.funcionario', $user->id) }}" class="row align-items-end">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="d-flex">
                        ...
                        <a href="{{ route('ponto.relatorio.funcionario', $user->id) }}" class="btn btn-secondary">
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="fas fa-calendar-alt me-2"></i>Registros de Ponto - {{ $user->email }}
                </h5>
        ...
        <div class="card-body">
            @if($registros->isEmpty())
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>Nenhum registro de ponto encontrado para este funcionário.
                </div>
            @else
